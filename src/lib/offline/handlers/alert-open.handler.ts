...
import type { OpenAlertInput, OpenAlertOutput } from '@/types/rpc';
...
export async function handleOpenAlert(item: OutboxItem): Promise<void> {
  ...
  const result = await callRpc<OpenAlertOutput>(
    'rpc_open_alert',
